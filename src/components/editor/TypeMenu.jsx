// TypeMenu.jsx — Menú acordeón con 4 grupos de tipos de elemento.
// Solo un grupo abierto a la vez. Al agregar un elemento, todos se cierran.
// UX para +50 años: botones grandes, descripción siempre visible, iconos claros.
...
export default function TypeMenu({ seccionId, onAgregar }) {
  ...
  const toggleGrupo = (idx) => setGrupoAbierto((prev) => (prev === idx ? null : idx))

  const handleAgregar = (tipo) => {
    onAgregar(seccionId, tipo)
    setGrupoAbierto(null) // cerrar todo al agregar
  }
